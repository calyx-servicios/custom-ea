...
This module create new groups and allows to you add new permissions and view in account models based in custom roles by EA Argentina.
...
1. Go to users, set the permissions.
