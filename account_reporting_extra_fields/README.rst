...
This module adds date, due date, partner and due days in account aged partner balance.
...
This module is part of the `Custom_ea <https://github.com/calyx-servicios/custom-ea>`_ project on Github.