...
This module extends the functionality of Account_invoice to automatically select the partner's salesperson(user_id) as Associate in the form view
...
1. When in form view, once Partner is selected, the Associate field will change to the partner's user_id
