====================================
Payment Follow-up Management PGK
====================================
...
This module extends the functionality of the [devit_account_followup] module to add a new template.
...
1. Accounting / Configuration / Tracking levels
